...
\usepackage[top=0.4in, bottom=0.4in, left=0.58in, right=0.58in]{geometry}
...
\par{\centering{\href{https://fr.linkedin.com/pub/yuxiang-li/65/553/356}{\huge Yuxiang \textsc{LI}}\par}} % Your name
...
% & \textsc{Objective:} & Looking for 3 month summer internship starting from June 2017
\end{tabular}
