...
% With Ubuntu and Sublime text
% 1. Install LatexTools and the font first
%    cp -R fontin2_pc /usr/local/share/fonts/ && fc-cache -fv
% 2. ctrl-shift-b -> basic builder xelatex

% With WSL and VS Code
...
%        }
%    ]
% 3. Build by running `xelatex -output-directory=tmp CV_En.tex` in the terminal
...
% Main document font, load from a custom location
\setmainfont{Fontin}[
    Path = fontin2_pc/,
    BoldFont = *-Bold,
    ItalicFont = *-Italic,
...
% The following can be used on Ubuntu after installing the font with
% `cp -R fontin2_pc /usr/local/share/fonts/ && fc-cache -fv`
